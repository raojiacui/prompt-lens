...
## 🚫 输出禁令（必须严格遵守）
1. **禁止任何开场白、自我介绍、寒暄语**。不要出现"好的"、"作为专业的提示词工程师"、"我将为您"之类的话。直接输出【画面深度描述】。
2. **禁止使用 Markdown 语法**。不要使用 *、**、###、- 等 Markdown 符号。用纯文本+上面的符号格式（如 📌 🎬 🏞️）即可。
3. 输出第一个字符必须是【画面深度描述】的【，不能是任何其他内容。
`;
...
## 🚫 输出禁令（必须严格遵守）
1. **禁止任何开场白、自我介绍、寒暄语**。不要出现"好的"、"作为专业的提示词工程师"、"我将为您"之类的话。直接输出【视频整体分析】。
2. **禁止使用 Markdown 语法**。不要使用 *、**、###、- 等 Markdown 符号。用纯文本+上面的符号格式（如 📌 🎬 🏞️）即可。
3. 输出第一个字符必须是【视频整体分析】的【，不能是任何其他内容。
`;
