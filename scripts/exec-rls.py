#!/usr/bin/env python3
"""Execute SQL on Supabase using psycopg2"""

import psycopg2

# Database credentials
DB_HOST = "db.vxlwqiohliynbtjwivte.supabase.co"
DB_PORT = 5432
DB_NAME = "postgres"
DB_USER = "postgres"
DB_PASSWORD = "20070729rjc131"
        ...
        for i, stmt in enumerate(statements, 1):
            try:
                ...
                if 'does not exist' in error_msg:
                    print(f"[{i}/{len(statements)}] Table/policy not found, skipping")
                else:
